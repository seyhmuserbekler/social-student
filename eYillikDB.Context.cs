...
namespace eYillik
{
    ...
    public partial class eYillikEntities : DbContext
    {
        public eYillikEntities()
            : base("name=eYillikEntities")
        {
        }
        ...
        public DbSet<sys_Album> sys_Album { get; set; }
        public DbSet<sys_BestTeacher> sys_BestTeacher { get; set; }
        public DbSet<sys_Pictures> sys_Pictures { get; set; }
        ...
        public DbSet<sys_Remembers> sys_Remembers { get; set; }
        ...
        public virtual ObjectResult<string> sys_AlbumleriGetir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("sys_AlbumleriGetir");
        }
    
        public virtual ObjectResult<sys_AlbumResimleriniGetir_Result> sys_AlbumResimleriniGetir(string albumName)
        {
            var albumNameParameter = albumName != null ?
                new ObjectParameter("AlbumName", albumName) :
                new ObjectParameter("AlbumName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_AlbumResimleriniGetir_Result>("sys_AlbumResimleriniGetir", albumNameParameter);
        }
    
        public virtual ObjectResult<sys_ProfilSayfasiGetir_Result> sys_ProfilSayfasiGetir(string userNumber)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_ProfilSayfasiGetir_Result>("sys_ProfilSayfasiGetir", userNumberParameter);
        }
    
        public virtual ObjectResult<sys_SohbetGetir_Result> sys_SohbetGetir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_SohbetGetir_Result>("sys_SohbetGetir");
        }
    
        public virtual ObjectResult<sys_SohbetKullanilariniGetir_Result> sys_SohbetKullanilariniGetir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_SohbetKullanilariniGetir_Result>("sys_SohbetKullanilariniGetir");
        }
    
        public virtual ObjectResult<sys_TumResimleriGetir_Result> sys_TumResimleriGetir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_TumResimleriGetir_Result>("sys_TumResimleriGetir");
        }
    
        public virtual int sys_AniEkle(string toUser, string fromUser, string rememberContent)
        {
            ...
            var rememberContentParameter = rememberContent != null ?
                new ObjectParameter("RememberContent", rememberContent) :
                new ObjectParameter("RememberContent", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sys_AniEkle", toUserParameter, fromUserParameter, rememberContentParameter);
        }
    
        public virtual ObjectResult<sys_KisininAnilariniGetir_Result> sys_KisininAnilariniGetir(string userNumber)
        {
            var userNumberParameter = userNumber != null ?
                new ObjectParameter("UserNumber", userNumber) :
                new ObjectParameter("UserNumber", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_KisininAnilariniGetir_Result>("sys_KisininAnilariniGetir", userNumberParameter);
        }
    
        public virtual ObjectResult<Nullable<System.Guid>> sys_KullaniciGetir(string userNumber)
        {
            var userNumberParameter = userNumber != null ?
                new ObjectParameter("userNumber", userNumber) :
                new ObjectParameter("userNumber", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<System.Guid>>("sys_KullaniciGetir", userNumberParameter);
        }
    }
}
